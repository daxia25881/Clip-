...
public extension UserDefaults
{
    ...
    @NSManaged var showClipboardNotification: Bool
    @NSManaged var showCloudNotification: Bool
    
    @NSManaged var snippetTargetPath: String?
    @NSManaged var webdavURL: String?
    @NSManaged var webdavUsername: String?
    @NSManaged var webdavPassword: String?
    @NSManaged var barkPath: String?
}
...
public extension UserDefaults
{
    func registerAppDefaults()
    {
        self.register(defaults: [
            ...
            #keyPath(UserDefaults.showClipboardNotification): true,
            #keyPath(UserDefaults.showCloudNotification): true
        ])
    }
}
