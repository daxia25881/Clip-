...
class HistoryViewController: UITableViewController
{
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        if identifier == "showSettings" {
            ...
            // Allow for non-modal presentation if needed, but standard sheet is good
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        ...
        // The rest of this function is technically dead code if shouldPerformSegue returns false,
        // but we leave it or remove it. Better to leave it for safety if logic changes, 
        // OR simply empty it. But since we return false above, this won't be called for showSettings.
...
private extension HistoryViewController
{
    func subscribe()
    {
        // TODO: Update once we can tell user to enable alternative background execution if needed.
    }
